...
class InceptionV3(object):
    ...
    def __init__(self, options):
        ...
        if options.PHASE == 'train':
            ...
            # training
            with arg_scope(inception.inception_v3_arg_scope(weight_decay=options.WEIGHT_DECAY,
            ...
            # validation
            with arg_scope(inception.inception_v3_arg_scope(weight_decay=0.0,
                                                            activation_fn=tf.nn.relu)):
    ...
    def get_init_weights_path(self, weights_root):
        return os.path.join(weights_root, 'inception_v3.ckpt')
