...
class InceptionV4(object):
    def __init__(self, num_classes, train_layers=None, weights_path='DEFAULT'):
        if weights_path == 'DEFAULT':
            self.WEIGHTS_PATH = os.path.join(cfg.TRAIN.PRETRAINED_WEIGHT_PATH, 'inception_v4.ckpt')
        else:
        ...
        # training
        with arg_scope(inception.inception_v4_arg_scope(weight_decay=cfg.TRAIN.WEIGHT_DECAY,
